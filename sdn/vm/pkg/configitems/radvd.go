...
func (c *RadvdConfigurator) Modify(ctx context.Context, oldItem, newItem depgraph.Item) (err error) {
...
func (c *RadvdConfigurator) NeedsRecreate(oldItem, newItem depgraph.Item) (recreate bool) {
	return true
}
